...
/**CÁC ĐƠN HÀNG CHƯA XỬ LÝ => status = 0 */

$sqlOrder = "SELECT * FROM orders WHERE status=0 ORDER BY order_id ASC";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="form-group">
                                            ...
                                            <a href="modules/order/proccess.php?action=update&order_id=<?php echo $order['order_id']; ?>" class="btn btn-warning"><i class="glyphicon glyphicon-pencil"></i></a>
                                            <a href="modules/order/proccess.php?action=delete&order_id=<?php echo $order['order_id']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
